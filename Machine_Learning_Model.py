...
# CSE 6242 Semester Project - Machine Learning Model
# 31 October 2018
...
# as it relates to the scaled "Rank" feature (the target feature of interest):
...
# Evaluate the model's accuracy in predicting scaled "Rank" values:
...
# -1 to 1). Certain literature sources that I saw defined an R^2 value of above 0.67 as
# "Substantial" (and not moderate or weak) in terms of performance. With more data 
# and model tweaking, our model should hopefully improve to optimized form, but 
