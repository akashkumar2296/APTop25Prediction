...
# CSE 6242 Semester Project - Final Trained Model
# 20 - 23 November 2018
...
Football_dataset = pd.read_csv("Dataset_Final_Historical_Data.csv")
...
# our model (see "Script_Final_Employed_Model_InProgress_Games"):
...
# the predicted and actual "Rank" values are strongly correlated (since 0.91 
...
# SECTION VII - MACHINE LEARNING MODEL (STORAGE):
...
Model_saved = "Model_trained.sav"
pickle.dump(Machine_learning_model, open(Model_saved, "wb"))

###############################################################################
###############################################################################

# SECTION VIII - REFERENCES (which helped guide us in all modeling scripts):
